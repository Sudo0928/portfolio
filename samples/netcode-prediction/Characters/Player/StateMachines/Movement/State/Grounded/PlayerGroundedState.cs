...
namespace GenshinImpactMovementSystem
{
    public class PlayerGroundedState : PlayerMovementState
    {
        ...
        protected override void AddInputActionsCallbacks()
        {
            ...
            Managers.Input.DashInput.started += OnDashStarted;

            Managers.Input.JumpInput.started += OnJumpStarted;
        }
        ...
        protected virtual void OnDashStarted(bool pressed)
        {
            stateMachine.ChangeState(stateMachine.DashingState);
        }

        protected virtual void OnJumpStarted(bool pressed)
        {
