        ...
        <div className="mt-8 grid gap-14 lg:grid-cols-[1.1fr_1fr] lg:gap-20">
          <div>
            ...
            <div className="text-muted-foreground mt-7 space-y-5 leading-8">
              <p>
                여럿이 같은 세계에 들어와도 서로의 화면이 어긋나지 않도록
                만드는 일에 관심을 가지고 있습니다. 무엇을 서버 기준으로 둘지와
                데이터를 어디에서 나눌지 같은 질문을 붙잡다 보니 자연스럽게 구조
                설계 쪽으로 오게 되었습니다.
              </p>
              <p>
                7인 팀 프로젝트에서는 한 명이 혼자 플레이하는 기준으로 짜여
                있던 구조를 서버 권위 멀티플레이로 다시 설계하였습니다.
