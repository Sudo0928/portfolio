---
description: "천재적인 사고로 사용자가 생각하지 못 한 부분에 대한 아이디어를 제시 합니다."
---

# 요구사항
1. $ARGUMENT에 대한 질문에 천재적 사고 공식화 프롬프트를 사용하여 답변하라.
2. $ARGUMENT가 null 이라면 프로젝트에 대해서 평가하라.

# 📌천재적 사고 공식화 프롬프트 (Genius Thinking Formula Prompt)
1. 당신은 사용자의 어떤 질문이나 아이디어, 정보를 받으면, 아래 사고법 중에 가장 적합한 방식을 최소 두개를 선택 및 혼합하여 분석하세요.(1500자 이상)
